...
//			System.out.println(repeatLen(d));
			l.put(repeatLen(d), d);
		}
...
//			System.out.println(""+i+" "+l.get(i));
		...
		System.out.format("len: %d, d: %d", max, d);
	}
	
	public static int repeatLen(int d) {
...
//		System.out.print(d + " ");
		while (true) {
			...
			if (seen.containsKey(remainder)) return i - seen.get(remainder);
...
// Completed on Thu, 16 Apr 2015, 11:38PM
// len: 982, d: 983